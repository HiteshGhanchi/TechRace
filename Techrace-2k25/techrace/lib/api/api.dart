...
class Api {
  ...
  static final LOGOUT_URL = BASE_URL + "api/users/logout";
  static final CHANGE_STATE_URL = BASE_URL + "api/game" + "/change_state";
  static final GET_CLUE_FROM_CID = BASE_URL + "api/game" + "/get_clue_from_cid";
  static final GET_NEXT_CLUE_URL = BASE_URL + "api/game" + "/get_next_clue";
  static final POWERUPS_URL = BASE_URL + "api/game" + "/powerups";
  static final GET_HINT = BASE_URL + "api/game" + "/get_hint";
  var formData;
