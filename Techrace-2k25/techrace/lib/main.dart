...
//   final player1ref = await ref.once();
//
//   final value = player1ref.snapshot.value; // Get the value
//
//   if (value != null) { // Check for null!
//     if (value is String) { // Check if it's a String (important for type safety)
//       MLocalStorage().setBaseUrl(value);
//       Api.BASE_URL = value;
//     } else {
//       // Handle the case where the value is NOT a string.  This is crucial!
//       print("Error: base_url value is not a string. It's a ${value.runtimeType}");
//       // Perhaps set a default value or throw an exception:
//       MLocalStorage().setBaseUrl("default_url"); // Or throw an error
//       Api.BASE_URL = "default_url";
//       // throw Exception("base_url must be a string");
//     }
//   } else {
//     // Handle the case where the value is null.  This is your original problem!
//     print("Error: base_url value is null. Check your Firebase database.");
//     // Set a default value or handle the error appropriately:
//     MLocalStorage().setBaseUrl("default_url"); // Or throw an error
//     Api.BASE_URL = "default_url";
//     // throw Exception("base_url is missing in Firebase");
//   }
// }
