...
// import 'login.dart';
//global vars
int clueNo = 0; //to be used to update the rtdb for every team whos beacon is detected
...
class _PilotState extends State<Pilot> {
  ...
  void initState() {
    ...
    _controller = Get.put(ValidationController());
    // print("clueNo: $clueNo");
    TimeStream();
  }
  ...
  textButtonTheme: TextButtonThemeData(
    style: ButtonStyle(
      backgroundColor: MaterialStateProperty.all(
          const Color.fromARGB(255, 110, 105, 105).withOpacity(0.2)),
    ),
  ),
);
